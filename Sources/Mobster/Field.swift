...
struct Field: Sendable {
    ...
    init(frame: Frame, columns: Int, rows: Int, locations: [SIMD2<Float>]) {
        self.frame = frame
    ...
    func distance(at location: SIMD2<Float>) -> Float {
    ...
    func direction(at location: SIMD2<Float>) -> SIMD2<Float> {
